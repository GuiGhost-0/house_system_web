...
function commitItem()
{
	...
	if(hid.length==0)
		...
		{
		   var mypart = "biao.skd="+skd+"&biao.dkd="+dkd+"&biao.mkd="+mkd+"&biao.hid="+hid + "&eid=" + eid + "&methodName=add";
		   var i = layer.load(0);
		   $.post(baseUrl + '/mybiao',mypart,function(mydata){
			 layer.close(i);
			 if(mydata==1)
				 {
