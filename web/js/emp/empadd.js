...
function commitItem()
{
	...
	if(erealname.length==0)
		...
		{
		   var mypart = "emp.myjs.jid=" + jid + "&emp.mydept.pid=" + pid+ "&emp.ename="+ename+"&emp.epsw="+epsw+"&emp.erealname="+erealname+"&emp.etel="+etel+"&emp.eaddress="+eaddress+"&emp.eremark="+eremark + "&methodName=add";
		   var i = layer.load(0);
		   $.post(baseUrl + '/myemp',mypart,function(mydata){
			 layer.close(i);
			 if(mydata==1)
				 {
